...
interface ConsolePageSkeletonProps {
...
/**
 * ConsolePageSkeleton — Suspense fallback shell that mimics a typical
 * console data view (page header + optional tabs + KPI strip + chart slot).
 * Used so cold-loads don't flash a blank panel while React waits for
 * useSearchParams + lazy data to resolve.
 */
export default function ConsolePageSkeleton({
  withTabs = false,
  kpiCount = 4,
  withChart = true,
  maxWidth = "6xl",
