...
import { GPU_NODES, GPU_GROWTH } from "@/lib/console/mock-data";
import { computeAxisTicks, generateSparklineData } from "@/lib/console/utils";
import type { NetworkStat } from "@/lib/console/types";
