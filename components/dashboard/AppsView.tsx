...
function TypeBadge({ kind }: { kind: AppDeployment["kind"] }) {
...
export default function AppsView() {
  ...
  const apps = allEnvs ? OWNED_APPS : appsInEnvironment(envFilter);
                ...
                >
                  ...
                  <div className="min-w-0">
                    <div className="flex min-w-0 items-center gap-2">
                      ...
                      {allEnvs && <EnvTag environmentId={app.deployment.environmentId} />}
                    </div>
                  ...
                  <div>
                    <TypeBadge kind={app.deployment.kind} />
                  </div>
                  <div>
                    <StatusCell status={app.deployment.status} />
                  </div>
                  <div>
