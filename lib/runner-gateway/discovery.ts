...
function appendQueryValues(url: string, pairs: Array<[string, string]>): string {
...
function runnerCandidatesFromDiscovery(entries: DiscoveryEntry[]): LiveRunnerInstance[] {
