...
const CATALOG_MODELS: App[] = [
  // ── Managed Services (SLA-backed) ──────────────────────────────────────────
  {
    ...
    category: "Video Generation",
    realtime: true,
    coverImage: "/images/console/daydream.png",
    description:
...
3. Use the API key in the \`Authorization\` header`,
  },
  {
    ...
    category: "Live Transcoding",
    realtime: true,
    coverImage: "/images/console/explore/frameworks-transcoding.webp",
    description:
...
Visit [frameworks.network](https://frameworks.network) to create an account and get your API key.`,
  ...
  // ── Network Capabilities ───────────────────────────────────────────────────
  {
    ...
    category: "Image Generation",
    coverImage: "/images/console/explore/flux-schnell.webp",
    description:
...
- NSFW content is filtered`,
  },
  {
    ...
    category: "Image Generation",
    coverImage: "/images/console/explore/sdxl-turbo.webp",
    description:
...
- 1024x1024 output resolution`,
  },
  {
    ...
    provider: "Stability AI",
    category: "Image Generation",
    coverImage: "/images/console/explore/img2img-sdxl.webp",
    description:
...
- **guidance_scale** (float, 1-20) — Prompt adherence`,
  },
  {
    ...
    provider: "Stability AI",
    category: "Video Generation",
    coverImage: "/images/console/explore/stable-video-diffusion.webp",
    description:
  ...
  },
  {
    ...
    category: "Video Editing",
    realtime: true,
    coverImage: "/images/console/explore/live-video-to-video.webp",
    description:
...
\`\`\``,
  },
  {
    ...
    provider: "Meta",
    category: "Language",
    coverImage: "/images/console/explore/llama-3-70b.webp",
    description:
...
This implementation has O(log n) time complexity and O(1) space complexity.`,
  ...
  },
  {
    ...
    category: "Speech",
    realtime: true,
    coverImage: "/images/console/explore/whisper-v3.webp",
    description:
...
99 languages supported with automatic detection.`,
  },
  {
    ...
    provider: "Hexgrad",
    category: "Speech",
    coverImage: "/images/console/explore/kokoro-tts.webp",
    description:
  ...
  },
  {
    ...
    category: "Video Understanding",
    realtime: true,
    coverImage: "/images/console/explore/depth-anything-v2.webp",
    description:
  ...
  },
  {
    ...
    category: "Video Understanding",
    realtime: true,
    coverImage: "/images/console/explore/yolov8.webp",
    description:
  ...
  },
  {
    ...
    category: "Video Understanding",
    realtime: true,
    coverImage: "/images/console/explore/sam-2-large.webp",
    description:
  ...
  },
  {
    ...
    provider: "LLaVA Team",
    category: "Language",
    coverImage: "/images/console/explore/llava-13b.webp",
    description:
  ...
  },
  {
    ...
    provider: "Xinntao",
    category: "Video Understanding",
    coverImage: "/images/console/explore/real-esrgan-4x.webp",
    description:
  ...
  },
  {
    ...
    provider: "Meta",
    category: "Speech",
    coverImage: "/images/console/explore/musicgen.webp",
    description:
  ...
  },
  {
    ...
    provider: "Nomic AI",
    category: "Language",
    coverImage: "/images/console/explore/nomic-embed.webp",
    description:
